...
# items...which may not all be created by the same system. That is, 
# without any form of synchronization, two or more separate computer 
# systems can create new items and label them with a UUID with no 
