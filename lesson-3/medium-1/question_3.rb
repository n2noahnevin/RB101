...
# without using begin/end/until? Note that we're not looking to find the
...
# number % divisor == 0 means there is no remainder, meaning divisor is
# a factor.

# The "factors" at the end is implicit return, because it is the last
# line, it is being returned.
